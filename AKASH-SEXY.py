...
def uaku():
	try:
		...
		a=requests.get('https://github.com/AKASH-404-2052/AKASH/blob/main/Approved.txt').text
		ua=open('.bbnew.txt','w')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Akash-2052/AKASH-SEXY/blob/main/ADMIN%20Approved").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
